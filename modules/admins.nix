...
let
  ...
  admins = {
    ...
    nerf = {
      hashedPassword = "$6$rounds=424242$FaEtIXMUScxgAYyF$Fl8GbPFgiEv.1iwrhtVpTixG1BTJys3aIfLyTzocQYZV4JymrYEXtnyCTURmVDe8stxbxgDutmtlyElfn1DQc/";
      keys = [
    ...
    bender = {
      hashedPassword = "$6$rounds=424242$H7lG3mtgKwx$xM1FQihMtl9MnN2CRLvoqdk1miYiNFELB6paHjBHAa0qzvf1eP4N7cLZ3W5Oh0o.LfjLZGk19LFd0gQS/R9YU/";
      keys = [
